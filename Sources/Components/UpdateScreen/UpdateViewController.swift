...
protocol UpdateViewControllerProtocol: AnyObject {
    func successUpdateBook()
}
...
final class UpdateViewController: UIViewController {
    ...
    private let idTextField = makeTextField(placeholderText: Constants.idPlaceholder)
    ...
    private let updateButton: UIButton = {
        ...
        button.titleLabel?.font = UIFont.boldSystemFont(ofSize: Constants.updateButtonFontSize)
    ...
    override func viewDidLoad() {
        ...
        updateButton.addTarget(self, action: #selector(tapUpdateButton), for: .touchUpInside)
        setupUI()
    }
    ...
    private func setupUI() {
        NSLayoutConstraint.activate([
            idTextField.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: Constants.topInset),
            idTextField.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: Constants.sideInset),
            idTextField.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -Constants.sideInset),
            idTextField.heightAnchor.constraint(equalToConstant: Constants.textFieldHeight),
    
            titleTextField.topAnchor.constraint(equalTo: idTextField.bottomAnchor, constant: Constants.verticalSpacing),
            ...
            updateButton.topAnchor.constraint(equalTo: publicationYearTextField.bottomAnchor, constant: Constants.buttonTopSpacing),
...
extension UpdateViewController: UpdateViewControllerProtocol {
    func successUpdateBook() {
...
private extension UpdateViewController {
    enum Constants {
        static let idPlaceholder = "Введити id книги"
        ...
        static let enableYearsText = "Доступный для выбора период: 1500 - 2026"
        static let addButtonTitle = "Изменить книгу"
        ...
        static let updateButtonFontSize: CGFloat = 24
